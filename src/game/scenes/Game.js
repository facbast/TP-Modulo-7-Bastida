...
export class Game extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        this.scoreText = this.add.text(12, 10, 'Altura: 0 m', {
            fontFamily: 'Arial Black', fontSize: '22px', color: '#ffffff',
            stroke: '#000000', strokeThickness: 5
        }).setScrollFactor(0).setDepth(100);
        this.bestText = this.add.text(12, 38, `Récord: ${this.best} m`, {
    ...
    update (time, delta)
    {
        ...
        if (this.ball.y < this.minY)
        {
            ...
            this.scoreText.setText(`Altura: ${this.score} m`);
            if (this.score > this.best) this.bestText.setText(`Récord: ${this.score} m`);
        }
